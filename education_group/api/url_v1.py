...
from education_group.api.views.mini_training import MiniTrainingDetail, MiniTrainingTitle, MiniTrainingList, \
    MiniTrainingOfferRoots
from education_group.api.views.training import TrainingList, TrainingDetail, TrainingTitle, TrainingOfferRoots
...
urlpatterns = [
    ...
    url(r'^trainings/(?P<year>[\d]{4})/(?P<acronym>[\w]+(?:[/ ]?[\w]{1,2}){0,2})/', include([
        ...
        url(r'^offer_roots$', TrainingOfferRoots.as_view(), name=TrainingOfferRoots.name),
    ...
    url(
        ...
        include([
            ...
            url(r'^offer_roots$', MiniTrainingOfferRoots.as_view(), name=MiniTrainingOfferRoots.name),
        ])
    ),
