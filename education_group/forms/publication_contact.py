...
from base.business.education_groups.publication_contact import postpone_publication_contact, postpone_publication_entity
...
class EducationGroupPublicationContactForm(forms.ModelForm):
    ...
    def save(self, *args, **kwargs):
        ...
        if self.data.get("to_postpone"):
            postpone_publication_contact(instance.education_group_year)
        return instance
...
class EducationGroupEntityPublicationContactForm(forms.ModelForm):
    ...
    def save(self, *args, **kwargs):
        instance = super().save(*args, **kwargs)
        if self.data.get("to_postpone"):
            postpone_publication_entity(instance)
        return instance
