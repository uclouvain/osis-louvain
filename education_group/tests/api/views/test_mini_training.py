...
class MiniTrainingListTestCase(APITestCase):
    ...
    def test_get_filter_from_year_to_year(self):
        mini_training1 = MiniTrainingFactory(academic_year__year=self.academic_year.year - 1)
        StandardEducationGroupVersionFactory(offer=mini_training1)
        mini_training2 = MiniTrainingFactory(academic_year__year=self.academic_year.year + 1)
        StandardEducationGroupVersionFactory(offer=mini_training2)
