...
class TestUpdateGetCommonBachelorAdmissionCondition(TestCase):
    @classmethod
    def setUpTestData(cls):
        cls.common_education_group_year = EducationGroupYearCommonBachelorFactory(academic_year__year=2018)
        ...
        cls.url = reverse('update_common_bachelor_admission_condition', kwargs={'year': 2018}) + \
    ...
    def test_case_bachelor_common_not_exists(self):
        dummy_url = reverse('update_common_bachelor_admission_condition', kwargs={'year': 1990})
        response = self.client.get(dummy_url)
...
class TestUpdatePostCommonBachelorAdmissionCondition(TestCase):
    @classmethod
    def setUpTestData(cls):
        cls.common_education_group_year = EducationGroupYearCommonBachelorFactory(academic_year__year=2018)
        AdmissionConditionFactory(education_group_year=cls.common_education_group_year)
