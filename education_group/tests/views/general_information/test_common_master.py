...
class TestCommonMasterAdmissionCondition(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.url = reverse('common_master_admission_condition', kwargs={'year': 2018})
    ...
    def test_case_common_and_admission_condition_not_exists(self):
        dummy_url = reverse('common_master_admission_condition', kwargs={'year': 1990})
        response = self.client.get(dummy_url)

        self.assertEqual(response.status_code, HttpResponseNotFound.status_code)

    def test_case_common_exist_but_admission_condition_not_exist(self):
        EducationGroupYearCommonMasterFactory(academic_year__year=1990)
    ...
    def test_assert_context_data(self):
        ...
        expected_publish_url = reverse('publish_common_master_admission_condition', kwargs={
...
class TestUpdateGetCommonMasterAdmissionCondition(TestCase):
    @classmethod
    def setUpTestData(cls):
        cls.common_education_group_year = EducationGroupYearCommonMasterFactory(academic_year__year=2018)
        ...
        cls.url = reverse('update_common_master_admission_condition', kwargs={'year': 2018}) + \
    ...
    def test_case_master_common_not_exists(self):
        dummy_url = reverse('update_common_master_admission_condition', kwargs={'year': 1990})
        response = self.client.get(dummy_url)
...
class TestUpdatePostCommonMasterAdmissionCondition(TestCase):
    @classmethod
    def setUpTestData(cls):
        cls.common_education_group_year = EducationGroupYearCommonMasterFactory(academic_year__year=2018)
        AdmissionConditionFactory(education_group_year=cls.common_education_group_year)
