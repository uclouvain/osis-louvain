...
def assistant_pst_part1(request, mandate_id):
    ...
    form = AssistantFormPart1(initial={'inscription': assistant.inscription,
                                       ...
                                       },prefix='assistant_part', instance=assistant)
    ...
    form2 = AssistantFormPart1b(initial={'external_functions': mandate.external_functions,
                                       ...
                                       'justification': mandate.justification
                                         },prefix='mandate_part', instance=mandate)
...
def pst_form_part1_save(request, mandate_id):
    ...
    form = AssistantFormPart1(data=request.POST, prefix="assistant_part", instance=mandate.assistant)
    form2 = AssistantFormPart1b(data=request.POST, prefix="mandate_part", instance=mandate)
    if form.is_valid() and form2.is_valid():
        form.save()
        form2.save()
        return assistant_pst_part1(request, mandate.id)
    else:
