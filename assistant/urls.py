...
urlpatterns = [
    ...
    url(r'^pst/form_part1/edit/(?P<mandate_id>\d+)/$', assistant_form.assistant_pst_part1, name='form_part1_edit'),
    url(r'^pst/form_part1/save/(?P<mandate_id>\d+)/$', assistant_form.pst_form_part1_save, name='form_part1_save'),
]