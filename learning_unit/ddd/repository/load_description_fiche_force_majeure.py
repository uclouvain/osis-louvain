...
def bulk_load_force_majeures(
    ...
    filter_clause = Q(text_label__label__in=CMS_LABEL_PEDAGOGY_FORCE_MAJEURE, language__in=['fr-be', 'en'])
    return bulk_load_cms(learning_unit_identities, filter_clause, DescriptionFicheForceMajeure, True)
