...
class TestLoadTree(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.link_level_1 = GroupElementYearFactory(
            parent=cls.root_node.education_group_year)  # TODO: Change to root_node when migration of group_element_year is done
    ...
    def test_case_tree_root_with_multiple_level(self):
        education_group_program_tree = load_tree.load(
            self.root_node.education_group_year.pk)  # TODO: Change to root_node.group_year_id when migration of group_element_year is done
