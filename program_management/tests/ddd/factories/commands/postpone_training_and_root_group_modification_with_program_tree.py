...
class PostponeTrainingAndRootGroupModificationWithProgramTreeCommandFactory(factory.Factory):
    class Meta:
        model = command.PostponeTrainingAndRootGroupModificationWithProgramTreeCommand
        abstract = False

    postpone_from_acronym = "Title "
