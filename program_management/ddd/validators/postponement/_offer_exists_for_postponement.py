...
# TODO :: unit tests
class OfferNotExistForPostponementValidator(BusinessValidator):
    def __init__(
            self,
        ...
        super(OfferNotExistForPostponementValidator, self).__init__()
    ...
    def validate(self):
        # To implement from get_instance_n1() (program_management/business/group_element_years/postponement)
