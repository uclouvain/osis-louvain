...
urlpatterns = [
    ...
    url(r'^students/list/$', student_resume.internships_student_resume, name='internships_student_resume'),
    url(r'^students/read/$', student_resume.internships_student_read, name='internships_student_read'),
]
