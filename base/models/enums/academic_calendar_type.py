...
CREATION_SPECIFIC_VERSION_CENTRAL_MANAGERS = "CREATION_SPECIFIC_VERSION_CENTRAL_MANAGERS"
CREATION_SPECIFIC_VERSION_FACULTY_MANAGERS = "CREATION_SPECIFIC_VERSION_FACULTY_MANAGERS"
...
ACADEMIC_CALENDAR_TYPES = (
    ...
    (CREATION_SPECIFIC_VERSION_CENTRAL_MANAGERS,
     _("Creation specific version by central managers")),
    (CREATION_SPECIFIC_VERSION_FACULTY_MANAGERS,
     _("Creation specific version by faculty managers")),
)
