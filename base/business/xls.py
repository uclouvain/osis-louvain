...
from base.models.academic_year import AcademicYear as AcademicYearDB, AcademicYear
...
def get_entity_version_xls_repr(acronym, academic_year):
    ...
    if type(academic_year) != AcademicYearDB:
        academic_year = AcademicYear.objects.get(year=academic_year.year)
    if mdl_base.entity_version.EntityVersion.is_entity_active(acronym, academic_year):
        return acronym
    else:
        # strikethrough styled str
        return '\u0336'.join(acronym) + '\u0336'
