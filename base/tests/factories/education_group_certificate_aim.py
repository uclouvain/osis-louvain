...
class EducationGroupCertificateAimFactory(DjangoModelFactory):
    class Meta:
        model = "base.EducationGroupCertificateAim"
    ...
    certificate_aim = factory.SubFactory(CertificateAimFactory)
